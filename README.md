...
| 👤  **跨應用登入** | [`login.html`](http://10.1.230.13:8000/login) | 加一行 [`oidc.js`](/oidc) 手動登入連結 |
| ⚡  **跨應用強制登入** | [`login_auto.html`](http://10.1.230.13:8000/login_auto) | 加一行 [`oidc.js`](/dean0123/oidc) 強制登入，顯示User |
